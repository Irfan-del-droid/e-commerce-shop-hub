...
export const mockProducts: Product[] = [
  {
    ...
    fullDescription:
      "Experience premium audio with our state-of-the-art wireless headphones. Features active noise cancellation, 30-hour battery life, and premium comfort padding for extended wear.",
    inStock: true,
  ...
  },
  {
    ...
    fullDescription:
      "Our ultra-thin laptop combines cutting-edge performance with portability. Perfect for developers, designers, and content creators who need power on the go.",
    inStock: true,
  ...
  },
  {
    ...
    fullDescription:
      "Track your health with precision. Monitor heart rate, sleep patterns, workouts, and more. Water-resistant design with 7-day battery life.",
    inStock: true,
  ...
  },
  {
    ...
    fullDescription:
      "Capture stunning 4K video and high-resolution photos. Perfect for professionals and enthusiasts alike.",
    inStock: true,
  ...
  },
  {
    ...
    fullDescription:
      "Designed for competitive gaming with ultra-responsive sensors and customizable buttons.",
    inStock: true,
  ...
  },
  {
    ...
    fullDescription:
      "Premium mechanical keyboard with customizable switches and stunning RGB backlighting.",
    inStock: true,
  ...
  },
  {
    ...
    fullDescription:
      "Experience gaming and content creation like never before with our stunning 4K display and 144Hz refresh rate.",
    inStock: true,
  ...
  },
  {
    ...
    fullDescription:
      "Fast storage on the go. USB-C 3.2 Gen 2 with speeds up to 1050MB/s. Compact and durable.",
    inStock: true,
  ...
  },
  {
    ...
    fullDescription:
      "Expand your laptop's connectivity with multiple USB ports, HDMI, SD card reader, and more.",
    inStock: true,
  ...
  },
  {
    ...
    fullDescription:
      "Premium aluminum phone stand for desk and bedside. Fits all phone sizes and provides optimal viewing angle.",
    inStock: true,
